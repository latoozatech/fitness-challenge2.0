...
const weeks = [
        ...
        { num: 4, theme: "Upper Body & Stability", exercises: [
            ...
            { name: "Shoulder Taps", note: "While plank - Left+Right = 1", beg: "30", int: "60", adv: "100", link: "https://youtu.be/yyFBdDj7EbQ?si=PncNErBXeT2llXEa" },
        ...
        { num: 5, theme: "Conditioning & Endurance", exercises: [
            ...
            { name: "Eccentric Dragonflag", note: "Slow and Controlled", beg: "8", int: "16", adv: "35", link: "https://musclewiki.com/exercise/eccentric-dragonflag?model=f" },
        ]},
        { num: 6, theme: "Core Control", exercises: [
            { name: "Russian Twists", note: "Left+Right = 1", beg: "40", int: "80", adv: "130", link: "https://musclewiki.com/exercise/dumbbell-russian-twist?model=f?model=f" },
        ...
        { num: 7, theme: "Power & Athleticism", exercises: [
            { name: "Squat Jumps", note: "or Squat Pulses", beg: "30", int: "55", adv: "90", link: "https://musclewiki.com/exercise/jump-squats?model=f?model=f" },
            { name: "Lateral Skaters", note: "Left+Right = 1", beg: "30", int: "55", adv: "90", link: "https://musclewiki.com/exercise/cardio-skater?model=f?model=f"},
            { name: "Push-Up w/T-Rotation", note: "or Just T-Rotation - Left+Right = 1", beg: "10", int: "20", adv: "40", link: "https://youtu.be/iChMWu10hVc?si=A3gYPHWQgKK4mTfj" },
            { name: "3 steps Heismans", note: "2 steps + Leg Up = 1 rep", beg: "20", int: "40", adv: "80", link: "https://musclewiki.com/exercise/cardio-three-step-heismans?model=f?model=f" },
            { name: "Walking Lunges", note: "1 step = 1 Rep", beg: "20", int: "40", adv: "80", link: "https://musclewiki.com/exercise/lunge-walking?model=f" },
            { name: "Crow Pose - PIPO", note: "Who Dares do it?", beg: "20s", int: "40s", adv: "80s", link: "https://musclewiki.com/exercise/crow-pose?model=f" },
        ]},
        { num: 8, theme: "Final Challenge Week", final: true, exercises: [
            { name: "Bulgarian Split Squats", note: "Each Leg", beg: "25", int: "50", adv: "75", link: "https://musclewiki.com/exercise/bulgarian-split-squat?model=f" },
            ...
            { name: "Wildcard", note: "Pick hardest move from previous weeks", beg: "5pts", int: "10pts", adv: "15pts" },
        ]}
    ];
